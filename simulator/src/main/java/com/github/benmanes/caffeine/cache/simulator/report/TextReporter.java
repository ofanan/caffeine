...
//      System.out.printf ("\n%s : ", policyStats.name());
//    System.out.printf ("Ratios: hit rate = %.2f%% fp = %.2f%%, fn = %.2f%%\n", 
//    100 * policyStats.tpFromReqRate(), 100 * policyStats.fpRate(), 100 * policyStats.fnRate());
//      System.out.printf ("Ratios: hit rate = %.2f%% fp = %.2f%%, fn = %.2f%%\n", 
//                          100 * policyStats.tpFromReqRate(), 100 * policyStats.fpRate(), 100 * policyStats.fnRate());
//      System.out.printf ("Ratios out of requests: tp = %.2f%% fp = %.2f%%, fn = %.2f%%, tn = %.2f%%\n", 
//          100 * policyStats.tpFromReqRate(), 100 * policyStats.fpFromReqRate(), 100 * policyStats.fnFromReqRate(), 100 * policyStats.tnFromReqRate());
//      System.out.printf ("M = 3: Normalized service cost: PI = %1.4f AI = %1.4f\n", 
//          policyStats.NormalizedPiServiceCost(3), policyStats.NormalizedAiServiceCost(3));

//      System.out.printf ("M = 10: Normalized service cost: PI = %1.4f AI = %1.4f\n", 
//          policyStats.NormalizedPiServiceCost(10), policyStats.NormalizedAiServiceCost(10));
    }
  }
...
//    }
  ...
  private Comparator<PolicyStats> makeComparator() {
    switch (settings.report().sortBy().toLowerCase(US)) {
      ...
      //$$ 
      case "fp misses":
          return Comparator.comparingLong(PolicyStats::fpCnt);
